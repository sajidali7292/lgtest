  ...
  return (
    <footer className={`${styles.mainW}`}>
      <div className={`container`}>
        <div className={`${styles.wrapTop} flex flex-row flex-wrap flex-wrap`}>
          <div className={`basis-full lg:basis-5/12`}>
            ...
            <div className={`${styles.rated} flex flex-row flex-wrap flex-wrap`}>
        ...
        <div className={`${styles.wrapBottom} flex flex-row flex-wrap flex-wrap`}>
          ...
          <div className="basis-full lg:basis-1/2">
            <ul className={`${styles.list_social} flex flex-wrap flex-row flex-wrap justify-center lg:justify-end align-middle items-center`}>
            ...
            <p className={`${styles.loc} text-center lg:text-right`}>{locationsLG}</p>
          </div>
        </div>
      </div>
    </footer>
